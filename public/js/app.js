...
(function () {
  ...
  function generateNotificationToggle(color) {
    ...
    return function (message) {
      ...
      var content = notification.querySelector('div.notification-item');
...
_toConsumableArray(document.getElementsByClassName("utc-to-local")).forEach(function (x) {
  if (!!x.value) x.value = dayjs.utc(x.value.trim()).local().format('lll');else x.textContent = dayjs.utc(x.textContent.trim()).local().format('lll');
});

(function () {
  var confirmModal = document.getElementById('__CONFIRM__MODAL__');
  var headlineDiv = document.getElementById('__CONFIRM__MODAL__HEADLINE__');
  var contentDiv = document.getElementById('__CONFIRM__MODAL__CONTENT__');
  var confirmButton = document.getElementById('__CONFIRM__MODAL__CONFIRM__');
  var cancelButton = document.getElementById('__CONFIRM__MODAL__CANCEL__');

  var hideConfirmModal = function hideConfirmModal() {
    return confirmModal.style.display = 'none';
  };

  var showConfirmModal = function showConfirmModal() {
    return confirmModal.style.display = 'initial';
  };

  window.confirm = function (_ref) {
    var _ref$onConfirm = _ref.onConfirm,
        onConfirm = _ref$onConfirm === void 0 ? function () {} : _ref$onConfirm,
        _ref$onCancel = _ref.onCancel,
        onCancel = _ref$onCancel === void 0 ? function () {} : _ref$onCancel,
        _ref$headline = _ref.headline,
        headline = _ref$headline === void 0 ? 'Are you sure?' : _ref$headline,
...
dayjs.extend(__webpack_require__(/*! dayjs/plugin/utc */ "./node_modules/dayjs/plugin/utc.js"));
dayjs.extend(__webpack_require__(/*! dayjs/plugin/localizedFormat */ "./node_modules/dayjs/plugin/localizedFormat.js"));
dayjs.extend(__webpack_require__(/*! dayjs/plugin/localeData */ "./node_modules/dayjs/plugin/localeData.js"));
